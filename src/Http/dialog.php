...
<head>
    ...
    <noscript>
        <link rel="stylesheet" href="<?php echo $vendor_path; ?>css/jquery.fileupload-noscript.css">
    </noscript>
    <noscript>
        <link rel="stylesheet" href="<?php echo $vendor_path; ?>css/jquery.fileupload-ui-noscript.css">
    </noscript>
                    ...
                    <div class="filters">
                        <div class="row-fluid">
                            ...
                            <div class="span2 half view-controller">
                                ...
                                <button class="btn tip<?php echo ($view == 2) ? " btn-inverse" : ""; ?>" id="view2" data-value="2" title="<?php echo __('View_columns_list'); ?>"><i class="icon-fire <?php echo ($view == 2) ? "icon-white" : ""; ?>"></i></button>
                            </div>
                            <div class="span6 entire types">
                                ...
                                <label id="ff-item-type-all" title="<?php echo __('All'); ?>" <?php echo ($_GET['type'] == 1 || $_GET['type'] == 3) ? 'style="visibility: hidden;"' : ''; ?> data-item="ff-item-type-all" for="select-type-all" style="margin-rigth:0px;" class="tip btn btn-inverse ff-label-type-all"><?php echo __('All'); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <li class="pull-right">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-left sorting">
                        ...
                        <li><a class="sorter sort-name <?php echo ($sort_by == "name") ? ($descending ? "descending" : "ascending") : ""; ?>" href="javascript:void('')" data-sort="name"><?php echo __('Filename'); ?></a></li>
                        <li><a class="sorter sort-date <?php echo ($sort_by == "date") ? ($descending ? "descending" : "ascending") : ""; ?>" href="javascript:void('')" data-sort="date"><?php echo __('Date'); ?></a></li>
                        <li><a class="sorter sort-size <?php echo ($sort_by == "size") ? ($descending ? "descending" : "ascending") : ""; ?>" href="javascript:void('')" data-sort="size"><?php echo __('Size'); ?></a></li>
                        <li><a class="sorter sort-extension <?php echo ($sort_by == "extension") ? ($descending ? "descending" : "ascending") : ""; ?>" href="javascript:void('')" data-sort="extension"><?php echo __('Type'); ?></a></li>
                    </ul>
                </div>
            </li>
            ...
            <?php } else { ?>
                ...
                <?php if ($config['show_sorting_bar']) { ?>
                    ...
                    <div class="sorter-container <?php echo "list-view" . $view; ?>">
                        <div class="file-name"><a class="sorter sort-name <?php echo ($sort_by == "name") ? ($descending ? "descending" : "ascending") : ""; ?>" href="javascript:void('')" data-sort="name"><?php echo __('Filename'); ?></a></div>
                        <div class="file-date"><a class="sorter sort-date <?php echo ($sort_by == "date") ? ($descending ? "descending" : "ascending") : ""; ?>" href="javascript:void('')" data-sort="date"><?php echo __('Date'); ?></a></div>
                        <div class="file-size"><a class="sorter sort-size <?php echo ($sort_by == "size") ? ($descending ? "descending" : "ascending") : ""; ?>" href="javascript:void('')" data-sort="size"><?php echo __('Size'); ?></a></div>
                        <div class='img-dimension'><?php echo __('Dimension'); ?></div>
                        <div class='file-extension'><a class="sorter sort-extension <?php echo ($sort_by == "extension") ? ($descending ? "descending" : "ascending") : ""; ?>" href="javascript:void('')" data-sort="extension"><?php echo __('Type'); ?></a></div>
                ...
                <ul class="grid cs-style-2 <?php echo "list-view" . $view; ?>" id="main-item-container">
                    ...
                    foreach ($files as $file_array) {
                        ...
                        ?>
                        <li data-name="<?php echo $file ?>" class="<?php echo $file == '..' ? 'back' : 'dir'; ?> <?php echo !$config['multiple_selection'] ? 'no-selector' : ''; ?>"
                            <?php echo ($filter != '' && stripos($file, $filter) === false) ? ' style="display:none;"' : '' ?>>
                            <?php
                            ...
                            ?>
                            <figure data-name="<?php echo $file ?>" data-path="<?php echo($ftp ? route('filemanager.fview.php') . '?ox=' . encrypt(['path' => $config['upload_dir'] . $rfm_subfolder . $subdir . $file, 'name' => $file]) : $rfm_subfolder . $subdir . $file); ?>"
                                    class="<?php echo($file == ".." ? "back-" : ""); ?>directory" data-type="<?php echo($file != ".." ? "dir" : ""); ?>">
                                <?php if ($file == "..") { ?>
                                ...
                                <a class="folder-link" href="dialog.php?<?php echo $get_params . rawurlencode($src) . "&" . ($callback ? 'callback=' . $callback . "&" : '') . uniqid() ?>">
                                    <div class="img-precontainer">
                                        <div class="img-container directory"><span></span>
                                            <img class="directory-img" data-src="<?php echo $vendor_path; ?>img/<?php echo $config['icon_theme']; ?>/folder<?php echo($file == ".." ? "_back" : ""); ?>.png"/>
                                        </div>
                                    </div>
                    ...
                    foreach ($files as $nu => $file_array) {
                        ...
                        if ((!($_GET['type'] == 1 && !$is_img) && !(($_GET['type'] == 3 && !$is_video) && ($_GET['type'] == 3 && !$is_audio))) && $class_ext > 0) {
                            ?>
                            <li class="ff-item-type-<?php echo $class_ext; ?> file <?php echo !$config['multiple_selection'] ? "no-selector" : "" ?>"
                                data-name="<?php echo $file; ?>" <?php echo ($filter != '' && stripos($file, $filter) === false) ? ' style="display:none;"' : ''; ?>>
                                <?php
                                $file_prevent_rename = false;
                                $file_prevent_delete = false;
                                if (isset($filePermissions[$file])) {
                                ...
                                ?>
                                <figure data-name="<?php echo $file ?>" data-path="<?php echo($ftp ? route('filemanager.fview.php') . '?ox=' . encrypt(['path' => $config['upload_dir'] . $rfm_subfolder . $subdir . $file, 'name' => $file]) : $rfm_subfolder . $subdir . $file); ?>"
                                        data-type="<?php echo $is_img ? "img" : "file"; ?>">
                                    <?php if ($config['multiple_selection']) { ?>
                                        <div class="selector">
                                        <label class="cont">
                                    ...
                                    <a href="javascript:void('')" class="link" data-file="<?php echo $file; ?>" data-function="<?php echo $apply; ?>">
                                        ...
                                        <div class="img-precontainer-mini <?php echo($is_img ? 'original-thumb' : ""); ?>">
                                            <?php if ($config['multiple_selection']) { ?>
                                            <?php } ?>
                                            <div class="filetype <?php echo $file_array['extension'] ?> <?php echo (in_array($file_array['extension'], $config['editable_text_file_exts'])) ? 'edit-text-file-allowed' : ''; ?> <?php echo !$is_icon_thumb ? "hide" : ""; ?>"><?php echo $file_array['extension'] ?></div>
                                            <div class="img-container-mini">
                                                <?php if ($mini_src != "") { ?>
                                        ...
                                        <?php } ?>
                                        <div class="box">
                                            <h4 class="<?php echo ($config['ellipsis_title_after_first_row']) ? "ellipsis" : ""; ?>"><?php echo $filename; ?></h4>
                                        </div>
                                    </a>
                                    <input type="hidden" class="date" value="<?php echo $file_array['date']; ?>"/>
                                    <input type="hidden" class="size" value="<?php echo $file_array['size'] ?>"/>
                                    ...
                                    <div class="file-date"><?php echo date(__('Date_type'), $file_array['date']) ?></div>
                                    <div class="file-size"><?php echo RFM::makeSize($file_array['size']) ?></div>
                                    <div class='img-dimension'><?php echo ($is_img) ? $img_width . "x" . $img_height : ''; ?></div>
                                    ...
                                    <figcaption>
                                        <form action="force_download.php" method="post" class="download-form" id="form<?php echo $nu; ?>">
                                            ...
                                            <a title="<?php echo __('Download') ?>" class="tip-right" href="javascript:void('')"
                                                <?php echo ($config['download_files']) ? "onclick=\"$('#form" . $nu . "').submit();\"" : ""; ?>>
                                                <i class="icon-download <?php echo (!$config['download_files']) ? 'icon-white' : ''; ?>"></i></a>
                                            ...
                                            <?php } elseif (($is_video || $is_audio) && in_array($file_array['extension'], $config['jplayer_exts'])) { ?>
                                                <a class="tip-right modalAV <?php echo ($is_audio) ? "audio" : "video"; ?>" title="<?php echo __('Preview') ?>" data-url="ajax_calls.php?action=media_preview&title=<?php echo $filename; ?>&file=<?php echo $rfm_subfolder . $subdir . $file; ?>" href="javascript:void('');"><i class=" icon-eye-open"></i></a>
                                            ...
                                            <?php } ?>
                                            <a href="javascript:void('')" class="tip-left edit-button rename-file-paths <?php echo ($config['rename_files'] && !$file_prevent_rename) ? "rename-file" : ''; ?>" title="<?php echo __('Rename') ?>" data-folder="0" data-permissions="<?php echo $file_array['permissions']; ?>">
                                                <i class="icon-pencil <?php echo (!$config['rename_files'] || $file_prevent_rename) ? 'icon-white' : ''; ?>"></i></a>

                                            <a href="javascript:void('')" class="tip-left erase-button <?php echo ($config['delete_files'] && !$file_prevent_delete) ? "delete-file" : ""; ?>" title="<?php echo __('Erase') ?>" data-confirm="<?php echo __('Confirm_del'); ?>">
                                                <i class="icon-trash <?php echo (!$config['delete_files'] || $file_prevent_delete) ? 'icon-white' : ''; ?>"></i>
                                            </a>
                                        </form>
                                    </figcaption>
                                </figure>
...
<?php if ($config['tui_active']) { ?>
    ...
    <script>
        if (image_editor) {
            ...
            $('.tui-image-editor-header-buttons div').replaceWith('<button class="tui-image-editor-exit-btn" ><?php echo __('Image_Editor_Exit'); ?></button>');
            $('.tui-image-editor-exit-btn').on('click', function () {
                exitTUI();
            });
            //Replace download button with save
            $('.tui-image-editor-download-btn').replaceWith('<button class="tui-image-editor-save-btn" ><?php echo __('Image_Editor_Save'); ?></button>');
